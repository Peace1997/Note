...
**总体策略**：
- 首先将目标位置分配给每个机器人；
- 每个智能体通过 策略（actor网络）根据获取的状态信息得到相应的动作，智能体执行动作，得到下一时刻状态，根据环境反馈的奖励以及Critic网络预测的价值来评判当前动作的好坏，以此指导actor网络的更新。
- 
**状态**：？
- 笛卡尔坐标系的位置、方向、速度；目标位置
**动作**：
- 过渡速度（transitional）和旋转速度（rotational）
**奖励：**
