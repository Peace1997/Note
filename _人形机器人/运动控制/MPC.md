...
>[! NOTE]
>角动量是描述物体相对于质心的旋转状态
>$$\mathbf{L} = \mathbf{r} \times m\mathbf{v} + I\boldsymbol{\omega}$$
>- $\mathbf{r} \times m\mathbf{v}$是质心以外的线动量造成的转动效应（轨道角动量）
>- $I\boldsymbol{\omega}$是物体自身绕质心旋转的部分（自转角动量）
