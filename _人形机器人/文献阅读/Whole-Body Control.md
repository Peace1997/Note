...
为了消除人类动捕数据带来的重定向的噪声与人体形态的差异带来的影响，直接从机器人/人形体操控空间中进行采样并构造物理可行的平衡全身轨迹，扩展数据至机器人特有的平衡可行解空间，
...
***contribution***
**运动重定向网络**：通过图卷机网络（ [[_深度学习/VAE#VQ-VAE|VQ-VAE]] ）将人类上身运动转换为人形机器人可执行的动作，每层通过 
