...
In the following, we consider the case of multiple subgroup number m = 5. Similarly(ˈsɪmələrli), the weighting parameter γ  > 1 is considered, the system reaches consensus in mean.
